...
<style lang="scss" scoped>
	...
	.enterprise .select_label .label_one .xiala_icon,.enterprise .select_label .label_two .xiala_icon{
		margin-left: 24upx;
		width: 25upx;
		height: 16upx;
	}
	...
	.enterprise .enterprise_list .enterprise_details .enterprise_content .list_lable_one,.enterprise .enterprise_list .enterprise_details .enterprise_content .list_lable_two{
		flex:1;
		margin-top: 26upx;
		align-items: center;
	}
